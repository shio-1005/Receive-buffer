...
{                                                                               //コンフィギュレーションモードに設定
    ...
    Write(_BFPCTRL , 0b00000000);                                               
    Write(_TXB0CTRL , 0b00000000);                                              
    Write(_RXB0CTRL , 0b00000000);                                              
    Write(_RXB1CTRL , 0b00000000);                                              
    Write(_CANINTE , 0b00000001);                                               //受信割り込み許可
    Write(_CANINTF , 0b00000000);                                               
    Write(_EFLG , 0b00000000);                                                  
...
void MCP2515_Open(char rxint)
{
    if(rxint == 1)
    {
        ...
        OPTION_REGbits.T0CS = 0;                                                //内部クロックに設定
        OPTION_REGbits.PSA = 0;                                                 //プリスケーラはTMR0に割り当て
